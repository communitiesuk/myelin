...
colleague picking the repository up afterwards finds the decision where
they would expect it and finds nothing of theirs disturbed. When you
finish, say plainly what state you have left things in.
